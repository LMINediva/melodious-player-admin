# 悦听影音后台管理系统前端界面	[English](README_en.md)

## 简介
这是一款基于Vue框架开源的软件，具备用户、角色、菜单、公告、反馈、安卓应用、音乐、MV和音乐清单管理、服务监控等功能。本项目基础架构来源于[**Java知识分享网**](https://www.java1234.com)，资源文件来源于互联网，本软件主要作为学习和交流使用。
